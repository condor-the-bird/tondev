...
`decodeOutputMessageBody` - decodes an outbound message.
...
[`getDeployData`](https://www.notion.so/28a3d16df9a44c24b0b21a5e09c2bf60) is the method designed to work with the original TON Lite-client. It takes a raw message body without headers (address, bounce flag, etc.). These are then added by the Lite-client.
